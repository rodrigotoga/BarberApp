...
SECRET_KEY = 'django-insecure-$9%j91*!23gqnu+mf*5clq^d+f5k!3nnm(&z0id*pe63+h!3f@'

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True

ALLOWED_HOSTS = []
AUTH_USER_MODEL = 'core.Cliente'  # App_name.ModelName
LOGIN_URL = 'login'  # Nome da URL de login
LOGIN_REDIRECT_URL = 'dashboard'  # Para onde redirecionar após login
